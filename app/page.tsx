...
export default function Home() {
  ...
  const exportMapPng = useMapStore((s) => s.exportMapPng)
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <header className="flex items-center h-14 px-4 bg-white border-b border-gray-200 shadow-sm shrink-0 z-20 gap-3">
        ...
        <div className="shrink-0">
          <ShareButton onExportPng={exportMapPng} />
        </div>
      </header>
