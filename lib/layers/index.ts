...
export const LAYERS: LayerDef[] = [
  // --- Flood (Must) ---
  {
    ...
    attribution:
      '<a href="https://disaportal.gsi.go.jp/" target="_blank">ハザードマップポータルサイト（国土交通省）</a>',
    defaultOpacity: 0.6,
    defaultVisible: true,
    color: '#3b82f6',
    priority: 'must',
  ...
  // earthquake-prob: J-SHIS tile host (maps.j-shis.bosai.go.jp) is no longer resolvable.
  // Earthquake probability is shown as text in the summary panel via the J-SHIS API instead.
  // --- Landslide warning (Must) ---
  {
    ...
    dataType: 'raster-tile',
    tileUrl:
      'https://disaportaldata.gsi.go.jp/raster/05_dosekiryu_warning_area_data/{z}/{x}/{y}.png',
    attribution:
      '<a href="https://disaportal.gsi.go.jp/" target="_blank">ハザードマップポータルサイト（国土交通省）</a>',
    defaultOpacity: 0.6,
    defaultVisible: false,
  ...
  // --- Landslide special (Must) ---
  {
    ...
    dataType: 'raster-tile',
    tileUrl:
      'https://disaportaldata.gsi.go.jp/raster/05_dosekiryu_kikenku_data/{z}/{x}/{y}.png',
    attribution:
      '<a href="https://disaportal.gsi.go.jp/" target="_blank">ハザードマップポータルサイト（国土交通省）</a>',
    defaultOpacity: 0.6,
    defaultVisible: false,
  ...
  // surface-geology: J-SHIS tile host (maps.j-shis.bosai.go.jp) is no longer resolvable.
  ...
  // ──────────────────────────────────────────────
  {
    ...
    dataType: 'raster-tile',
    tileUrl:
      'https://cyberjapandata.gsi.go.jp/xyz/experimental_evac/{z}/{x}/{y}.png',
    attribution:
